...
function calculate() {
  // first element
  // read price
  var elem1price = parseInt(
    document.getElementById("firselementPrice").textContent
  );
  // read quantity
  ...
  // second elemnet
  // read price
  var elem2price = parseInt(
    document.getElementById("secondelementPrice").textContent
  );
  // read quantity
  ...
  // third elemnet
  // read price
  var elem3price = parseInt(
    document.getElementById("thirdelementPrice").textContent
  );
  // read quantity
  ...
  // fourth elemnet
  // read price
  var elem4price = parseInt(
    document.getElementById("forthelementPrice").textContent
  );
  // read quantity
  ...
  // fiveth elemnet
  // read price
  var elem5price = parseInt(
    document.getElementById("fithelementPrice").textContent
  );
  // read quantity
  ...
  // sixth elemnet
  // read price
  var elem6price = parseInt(
    document.getElementById("sixthelementPrice").textContent
  );
  // read quantity
  ...
  // calculation
  var solution =
    elem1price * elem1quant +
    elem2price * elem2quant +
    elem3price * elem3quant +
    elem4price * elem4quant +
    elem5price * elem5quant +
    elem6price * elem6quant;
